...
body[data-dsw-win2k] [role="tab"]{background-color:#d4d0c8;box-shadow:inset -1px -1px #404040,inset 1px 1px #ffffff;border-radius:0;margin-top:2px}
body[data-dsw-win2k] [role="tab"][aria-selected="true"]{background-color:#ffffff;color:#000000;margin-top:0;box-shadow:inset 0 0 0 1px #404040,inset 1px 1px 0 #ffffff,inset -1px 0 0 #808080}
...
/* The defragmenter map, in the one place this page has room for it: the empty
   state. Two greys on the 8px cell the shell used, faint enough to read as
   paper rather than noise. */
body[data-dsw-win2k] [class*="composerHero"]{background-image:repeating-conic-gradient(#efedea 0% 25%,transparent 0% 50%);background-size:8px 8px}
...
body[data-dsw-win2k] :focus-visible{outline:1px dotted #000000;outline-offset:-1px}
