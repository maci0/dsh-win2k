...
body[data-dsw-win2k] button[aria-label="Remove rating"]:has(svg),body[data-dsw-win2k] button[aria-label="取消标记"]:has(svg):has(svg){background:url("data:image/png;base64,") center/16px 16px no-repeat}
