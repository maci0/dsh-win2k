...
- **Period metrics, not just colours.** A 20px caption bar carrying the ActiveTitle → GradientActiveTitle horizontal gradient with white ink, 12px bold Tahoma in it, grey 16x14-style control plates on it; 18px menu rows; a 16px scrollbar with real arrow buttons at each end; square corners everywhere.
