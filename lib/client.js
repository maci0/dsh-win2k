...
body[data-dsw-win2k] button:hover:not([disabled]):not([aria-disabled="true"]):not([role="menuitem"]):not([role="menuitemradio"]):not([aria-selected="true"]):not([class*="_dock"] *){background-color:#e4e1dc}
