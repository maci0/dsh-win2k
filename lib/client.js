...
body[data-dsw-win2k] [class*="fileMention"] svg[width],body[data-dsw-win2k] [class*="fileLink"] svg[width],body[data-dsw-win2k] [class*="_tile"] svg[width],body[data-dsw-win2k] [class*="tabStrip"] button svg,body[data-dsw-win2k] button[data-sidebar-right-expand] svg,body[data-dsw-win2k] [class*="iconWrap"] svg,body[data-dsw-win2k] [class*="chevron"] svg,body[data-dsw-win2k] [class*="iconButton"] svg{background-size:contain}
