...
body[data-dsw-win2k] header:has([data-conversation-header-leading]) > div:first-child button{height:18px !important;min-height:18px !important;padding:0 2px !important}
...
body[data-dsw-win2k] header:has([data-conversation-header-leading]) [class*="split"]{border:0;height:18px;min-height:18px;box-sizing:border-box}
...
body[data-dsw-win2k] header:has([data-conversation-header-leading]) [class*="seat"]{height:18px;min-height:18px;padding:0 2px;gap:5px}
body[data-dsw-win2k] header:has([data-conversation-header-leading]) [class*="headerActions"] span[class*="label"],
body[data-dsw-win2k] header:has([data-conversation-header-leading]) [class*="headerActions"] span[class*="label"] *,
