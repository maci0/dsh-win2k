...
/* The Session header is this page's title bar. Windows 2000 never dropped the
   navy caption, so the title row takes ActiveTitle with white ink; the tab
   strip below it stays a face control. */
body[data-dsw-win2k] header:has([data-conversation-header-leading]) > div:first-child{background-color:#0a246a}
body[data-dsw-win2k] header:has([data-conversation-header-leading]) > div:first-child,
body[data-dsw-win2k] header:has([data-conversation-header-leading]) > div:first-child *{color:#ffffff}
