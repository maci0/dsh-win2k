...
body[data-dsw-win2k] [class*="addButton"]{border:0;height:23px;min-height:23px}
...
body[data-dsw-win2k] [class*="cardTrailing"] [class*="tag"],body[data-dsw-win2k] [class*="statusTag"]{background-color:#d4d0c8;box-shadow:var(--dw-raised);color:#000000}
